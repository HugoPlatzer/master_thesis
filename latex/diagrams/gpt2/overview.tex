...
\node[my caption node, left=of if]{Token (integer) \\ sequence};


\node[my block node, color 1, above=of if] (pp) {Preprocessing};
\draw[arrow style] (if) to (pp);

\node[block data node, above=of pp] (v2) {$\modHiddenAt{0}_2$};
\node[block data node, left=of v2] (v1) {$\modHiddenAt{0}_1$};
\node[block data node, right=of v2] (v3) {$\modHiddenAt{0}_3$};
...
\node[block data node, above=of b2] (hout2) {$\modHiddenAt{12}_2$};
\node[block data node, left=of hout2] (hout1) {$\modHiddenAt{12}_1$};
\node[block data node, right=of hout2] (hout3) {$\modHiddenAt{12}_3$};
...
\node[block data node, above=of pop] (p2) {$\modOut_2$};
\node[block data node, left=of p2] (p1) {$\modOut_1$};
\node[block data node, right=of p2] (p3) {$\modOut_3$};
