...
\node[data node] (x1) at (cx1) {$\modHidden_1$};
\node[data node] (x2) at (cx2) {$\modHidden_2$};
...
\node[medium container node, medium gap, above=of l1] (ck1) {};
\node[medium container node, medium gap, left=of ck1] (cq1) {};
\node[medium container node, medium gap, right=of ck1] (cv1) {};
\node[medium container node, medium gap, above=of l2] (ck2) {};
\node[medium container node, medium gap, left=of ck2] (cq2) {};
\node[medium container node, medium gap, right=of ck2] (cv2) {};

\node[data node] at (cq1) (q1) {$\mathbf{q}_1$};
\node[data node] at (ck1) (k1) {$\mathbf{k}_1$};
\node[data node] at (cv1) (v1) {$\mathbf{v}_1$};
\node[data node] at (cq2) (q2) {$\mathbf{q}_2$};
\node[data node] at (ck2) (k2) {$\mathbf{k}_2$};
\node[data node] at (cv2) (v2) {$\mathbf{v}_2$};
...
\node[small container node, large gap, above=of cq1, anchor=east] (cq1h1) {};
\node[small container node, large gap, above=of cq1, anchor=west] (cq1h2) {};
\node[small container node, large gap, above=of ck1, anchor=east] (ck1h1) {};
\node[small container node, large gap, above=of ck1, anchor=west] (ck1h2) {};
\node[small container node, large gap, above=of cv1, anchor=east] (cv1h1) {};
\node[small container node, large gap, above=of cv1, anchor=west] (cv1h2) {};
\node[small container node, large gap, above=of cq2, anchor=east] (cq2h1) {};
\node[small container node, large gap, above=of cq2, anchor=west] (cq2h2) {};
\node[small container node, large gap, above=of ck2, anchor=east] (ck2h1) {};
\node[small container node, large gap, above=of ck2, anchor=west] (ck2h2) {};
\node[small container node, large gap, above=of cv2, anchor=east] (cv2h1) {};
\node[small container node, large gap, above=of cv2, anchor=west] (cv2h2) {};

\node[data node] (q1h1) at (cq1h1) {$\mathbf{q}_{1_{ \textcolor{h1color}{1} }}$};
\node[data node] (q1h2) at (cq1h2) {$\mathbf{q}_{1_{ \textcolor{h2color}{2} }}$};
\node[data node] (k1h1) at (ck1h1) {$\mathbf{k}_{1_{ \textcolor{h1color}{1} }}$};
\node[data node] (k1h2) at (ck1h2) {$\mathbf{k}_{1_{ \textcolor{h2color}{2} }}$};
\node[data node] (v1h1) at (cv1h1) {$\mathbf{v}_{1_{ \textcolor{h1color}{1} }}$};
\node[data node] (v1h2) at (cv1h2) {$\mathbf{v}_{1_{ \textcolor{h2color}{2} }}$};
\node[data node] (q2h1) at (cq2h1) {$\mathbf{q}_{2_{ \textcolor{h1color}{1} }}$};
\node[data node] (q2h2) at (cq2h2) {$\mathbf{q}_{2_{ \textcolor{h2color}{2} }}$};
\node[data node] (k2h1) at (ck2h1) {$\mathbf{k}_{2_{ \textcolor{h1color}{1} }}$};
\node[data node] (k2h2) at (ck2h2) {$\mathbf{k}_{2_{ \textcolor{h2color}{2} }}$};
\node[data node] (v2h1) at (cv2h1) {$\mathbf{v}_{2_{ \textcolor{h1color}{1} }}$};
\node[data node] (v2h2) at (cv2h2) {$\mathbf{v}_{2_{ \textcolor{h2color}{2} }}$};
...
\node[data node, large gap] (q1h1s) at (cq1h1s) {$\mathbf{q}_{1_{ \textcolor{h1color}{1} }}$};
\node[data node, large gap] (q2h1s) at (cq2h1s) {$\mathbf{q}_{2_{ \textcolor{h1color}{1} }}$};
\node[data node, large gap] (k1h1s) at (ck1h1s) {$\mathbf{k}_{1_{ \textcolor{h1color}{1} }}$};
\node[data node, large gap] (k2h1s) at (ck2h1s) {$\mathbf{k}_{2_{ \textcolor{h1color}{1} }}$};
\node[data node, large gap] (v1h1s) at (cv1h1s) {$\mathbf{v}_{1_{ \textcolor{h1color}{1} }}$};
\node[data node, large gap] (v2h1s) at (cv2h1s) {$\mathbf{v}_{2_{ \textcolor{h1color}{1} }}$};
\node[data node, large gap] (q1h2s) at (cq1h2s) {$\mathbf{q}_{1_{ \textcolor{h2color}{2} }}$};
\node[data node, large gap] (q2h2s) at (cq2h2s) {$\mathbf{q}_{2_{ \textcolor{h2color}{2} }}$};
\node[data node, large gap] (k1h2s) at (ck1h2s) {$\mathbf{k}_{1_{ \textcolor{h2color}{2} }}$};
\node[data node, large gap] (k2h2s) at (ck2h2s) {$\mathbf{k}_{2_{ \textcolor{h2color}{2} }}$};
\node[data node, large gap] (v1h2s) at (cv1h2s) {$\mathbf{v}_{1_{ \textcolor{h2color}{2} }}$};
\node[data node, large gap] (v2h2s) at (cv2h2s) {$\mathbf{v}_{2_{ \textcolor{h2color}{2} }}$};
...
\node [data node] (a2h1) at (ca2h1) {$\mathbf{a}_{2_{ \textcolor{h1color}{1} }}$};
\node [data node] (a2h2) at (ca2h2) {$\mathbf{a}_{2_{ \textcolor{h2color}{2} }}$};
...
\node[data node] (a2) at (ca2) {$\mathbf{a}_2$};

\draw[my arrow style] (ca2h1) to (ca2);
\draw[my arrow style] (ca2h2) to (ca2);

\node[my block node, color 3, above=of ca2] (lproj) {Linear};

\draw[my arrow style] (ca2) to (lproj);

\node[medium container node, above=of lproj] (cout) {};
\node[data node] (out) at (cout) {$\modHidden'_2$};

\draw[my arrow style] (lproj) to (out);
