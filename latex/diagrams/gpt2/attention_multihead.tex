...
%\node [data node] (a1h1) at (ca1h1) {$\mathbf{a}_{1_{ \textcolor{h1color}{1} }}$};
\node [data node] (a2h1) at (ca2h1) {$\mathbf{a}_{2_{ \textcolor{h1color}{1} }}$};
%\node [data node] (a1h2) at (ca1h2) {$\mathbf{a}_{1_{ \textcolor{h2color}{2} }}$};
...
%\node[data node] (a1) at (ca1) {$\mathbf{a}_1$};
...
%\node[data node] (y1) at (cy1) {$\modHidden'_1$};
%\node[data node] (y2) at (cy2) {$\modHidden'_2$};
