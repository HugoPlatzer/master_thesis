...
All datasets are sampled using the \textbf{basic sampling} method illustrated in \cref{methods:sampling:basic}. This applies to all experiments except those studying different sampling methods (\cref{setup:sampling}).
