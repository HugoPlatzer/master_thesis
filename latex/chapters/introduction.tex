...
We study the performance of small (around $10^7$ parameters) transformer networks with a similar architecture to OpenAI GPT2 on addition (3 to 10 decimal digits), multiplication (3 to 10 decimal digits), and integer square root (6 to 20 decimal digits). Training dataset sizes range from $10^3$ to $10^5$ samples, with character-level tokenization based on ASCII character values.
