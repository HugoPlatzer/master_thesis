...
\includePDFPlot{experiment_results/heatmaps/add_simple_1.pdf}{fig:heatmap_add_simple1}{First block activation heatmap for the addition task "123+456".}
...
\includePDFPlot{experiment_results/heatmaps/add_simple_2.pdf}{fig:heatmap_add_simple2}{First block activation heatmap for the addition task "999+001".}
...
\includePDFPlot{experiment_results/heatmaps/add_5digits_1.pdf}{fig:heatmap_add_5digits}{First block activation heatmap for the addition task "12345+67890".}
...
\includePDFPlot{experiment_results/heatmaps/add_rev_1.pdf}{fig:heatmap_add_rev}{First block activation heatmap for the addition task "123+456", using result reversal.}
...
\includePDFPlot{experiment_results/heatmaps/add_scratch_1.pdf}{fig:heatmap_add_scratch}{First block activation heatmap for the addition task "123+456", using result reversal.}
...
\includePDFPlot{experiment_results/heatmaps/mul_1.pdf}{fig:heatmap_mul}{First block activation heatmap for the multiplication task "123*456".}
...
\includePDFPlot{experiment_results/heatmaps/sqrt_1.pdf}{fig:heatmap_sqrt}{First block activation heatmap for the integer square root task "123456".}
